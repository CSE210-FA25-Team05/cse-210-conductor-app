...
export class StudentAttendance extends HTMLElement {
  ...
  createForm() {
    ...
    this.form.style = 'display: flex; flex-direction: row; align-items: center; justify-content: center; gap: 1em';
  ...
  async getStatus() {
    ...
    const attendance = await getUserAttendance(this.courseId, this.lectureId, this.userId);
